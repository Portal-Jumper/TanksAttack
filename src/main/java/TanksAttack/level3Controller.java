...
public class level3Controller {
	...
	private ImageView image1, image2, image3, image4, image5, image6, image7, image8, image9, image10, image11, image12,
			image13, image14, image15, image16, image17,  image21, image22, image23, image24,
			...
			image73, image74, image75, image76, image77, image78, image79,  image81, image82, image83, image84,
			image85, image86, image87, image88, image89, image90, image91, image92, image93, image94, image95, image96,
			image97, image98, image100, image101, image102, image103, image104,
			image108, image109, image110, image111, image112, image113, image114, image115, image116, image117,
			image118, image120, image121, image122, image123, image124, image127,
			image128, image129, image130, image131, image132, image133, image134, image135, image136, image137,
			image138, image139, image140, image141, image142, image143, image144, image145, image146, image147,
			image148, image149, image150, image151, image152, image153, image154, image155, image156, image157,
			image158, image159, image160, image161, image162, image163, image164, image165, image166, image167,
			image168, image169, image170, image171, image172, image173, image174, image175, image176, image177,
			image178, image179, image180, image181, image182, image183, image184, image185, image186, image187,
			image188, image189, image190, image191, image192, image193, image194, image195,  image197,
			image198, image199, image200, image201, image202, image203, image204, image205, image206, image207,
			image208, image209, image210, image211, image213, image214,  image216, image217,
			image218, image219, image220, image221, image222, image223, image224, image225, image226, image227,
			image228, image229, image230,  image232;
...
//     Map Generation
	...
	private void generateMap() {
		fillEnemyTanks();
		level1Controller.addToBricks(image1, image2, image3, image4, image5, image6, image7, image8, image9, image10, blocks, bricks, brickImage);
		level1Controller.addToBricks(image11, image12, image13, image14, image15, image16, image17,image211,image213,image214,  blocks, bricks, brickImage);
		level1Controller.addToBricks(image21, image22, image23, image24, image25, image26, image27, image28, image29, image30, blocks, bricks, brickImage);
		level1Controller.addToBricks(image31, image32, image33,  image37, image38, image39, image40,image216,image217,image218, blocks, bricks, brickImage);
		level1Controller.addToBricks(image41, image42, image43, image44, image45, image46, image47, image48, image49, image50, blocks, bricks, brickImage);
		level1Controller.addToBricks(image51, image52, image53, image54, image55, image56, image57, image58, image59, image60, blocks, bricks, brickImage);
		level1Controller.addToBricks(image61, image62, image63, image64, image65, image66, image67, image68, image69, image70, blocks, bricks, brickImage);
		level1Controller.addToBricks(image71, image72, image73, image74, image75, image76, image77, image78, image79,image219,  blocks, bricks, brickImage);
		level1Controller.addToBricks(image81, image82, image83, image84, image85, image86, image87, image88, image89, image90, blocks, bricks, brickImage);
		level1Controller.addToBricks(image91, image92, image93, image94, image95, image96, image97, image98,  image100,image220, blocks, bricks, brickImage);
		level1Controller.addToBricks(image111, image112, image113, image114, image115, image116, image117, image118,  image120,image109, blocks, bricks, brickImage);
		level1Controller.addToBricks(image121, image122, image123, image124, image101,image102, image127, image128, image129, image130, blocks, bricks, brickImage);
		level1Controller.addToBricks(image131, image132, image133, image134, image135, image136, image137, image138, image139, image140, blocks, bricks, brickImage);
		level1Controller.addToBricks(image141, image142, image143, image144, image145, image146, image147, image148, image149, image150, blocks, bricks, brickImage);
		level1Controller.addToBricks(image151, image152, image153, image154, image155, image156, image157, image158, image159, image160, blocks, bricks, brickImage);
		level1Controller.addToBricks(image161, image162, image163, image164, image165, image166, image167, image168, image169, image170, blocks, bricks, brickImage);
		level1Controller.addToBricks(image171, image172, image173, image174, image175, image176, image177, image178, image179, image180, blocks, bricks, brickImage);
		level1Controller.addToBricks(image181, image182, image183, image184, image185, image186, image187, image188, image189, image190, blocks, bricks, brickImage);
		level1Controller.addToBricks(image191, image192, image193, image194, image195,  image197, image198, image199, image110, image200, blocks, bricks, brickImage);
		level1Controller.addToBricks(image201, image202, image203, image204, image205, image206, image207, image208, image209, image210, blocks, bricks, brickImage);
		level1Controller.addToBricks(image221, image222, image223, image224, image225, image226, image227, image228, image229, image230, blocks, bricks, brickImage);
		bricks.add(image232);
		bricks.add(image103);
		bricks.add(image104);
		bricks.add(image108);
		...
		blocks.add(image104);
		blocks.add(image108);
		image103.setImage(brickImage);
		image104.setImage(brickImage);
		image108.setImage(brickImage);
		image232.setImage(brickImage);
